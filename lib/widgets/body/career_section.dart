    ...
    return const Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [WhiteNormalTxt(txt: "Carrer", size: 60)],
          ),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              WhiteNormalTxt(txt: "다양한 경험과 지식", size: 25),
            ],
          ),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              WhiteNormalTxt(txt: "DB, 프레임워크, 서버", size: 35),
            ],
          ),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Row(
            ...
            children: [
              WhiteNormalTxt(
                  txt: "UISP(안경원 관리 프로그램), UICS(전자주문 프로그램), UION(고객관리 프로그램 앱),UIBOX(안경전용 B2B쇼핑몰 프로그램)\n"

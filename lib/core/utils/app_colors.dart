...
abstract class AppColors {
  ...
  static Color primaryColor = const Color(0xffe1a67d);
  ...
  static Color blueColor = const Color(0xff4687f6);
  static Color linkColor = const Color(0xff6ba1f8);
  static Color orangeColor = const Color(0xffe78b4a);
  static Color scaffoldColor = const Color(0xff1A1A29);
  static Color appBarColor = const Color(0xffc2753e);
  // static Color appBarColor = const Color(0xff181824);
  static Color primaryLight = const Color(0xff31313F);
  static Color boarderLine = const Color(0x18000000);
}
